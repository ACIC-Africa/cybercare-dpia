...
NOTIFICATION_UPDATE = f"{NOTIFICATION}:{UPDATE}"
...
PRIVACY_REQUEST_IMPORT = f"{PRIVACY_REQUEST}:{IMPORT}"
...
SCOPE_DOCS = {
    ...
    PRIVACY_REQUEST_IMPORT: "Import historical, already-completed privacy requests",
